...
// AuthorizationMiddleware は認可チェックを行うミドルウェア
func AuthorizationMiddleware(authzService *service.AuthorizationService, resource, action string) gin.HandlerFunc {
...
// RequirePermission は指定したリソースとアクションに対する権限を要求するミドルウェアを返す
